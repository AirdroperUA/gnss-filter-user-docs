...
- Якщо `SNR_EN=1` і `SNR=NA` тримається понад 30 секунд, у GCS фіксується попередження `WARNING: SNR_EN=1 but SNR=NA`. SNR-захист не може спрацювати, поки відсутні SNR-дані.
