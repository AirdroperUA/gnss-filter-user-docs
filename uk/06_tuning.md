...
- **DR1_MAXMS**: Максимальний час (мс) перебування в DR1 до примусового виходу в DR0. `0` = вимкнено (за замовчуванням — DR1 тримається поки GPS не відновиться). Типові значення: `60000` (1 хв), `120000` (2 хв), `300000` (5 хв).
