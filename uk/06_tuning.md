...
- **FENCE_RAD**: Радіус гео-огорожі в метрах від позиції першого фіксу (макс. 2 000 000 м = 2000 км). За замовчуванням `600000` (600 км). Якщо GPS показує позицію за цим радіусом — спрацьовує DR1. `0` = вимкнено. Центр огорожі встановлюється при першому фіксі після увімкнення.
