...
Якщо змінюєте `GNSS_TYPE`, перезавантажте STM32 (`NRST` або повне вимкнення/увімкнення), щоб зміна застосувалась.
Якщо змінюєте `UBX_BAUD`, також перезавантажте STM32 (`NRST` або повне вимкнення/увімкнення), щоб зміна застосувалась.
Після оновлення прошивки запустіть:
