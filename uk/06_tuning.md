...
- **UBX_BAUD**: Керування baud/автоконфігом u-blox. `0` залишає автоконфіг увімкненим (режим за замовчуванням). Значення `>0` вимикає автоконфіг і використовує цей ручний baud. Застосовується після перезавантаження.
