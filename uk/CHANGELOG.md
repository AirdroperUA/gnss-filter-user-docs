...
- Без видимих користувачу змін. Внутрішні оновлення паритету з хвилі посилення R19; межа захисту від відкату залишається на v1.5.5, щоб існуючі польові пристрої могли прийняти цей реліз.
