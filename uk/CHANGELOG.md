...
- **Update тепер перевіряє активацію ліцензії до роботи з RDP**: desktop app
  ...
  ліцензія невалідна, не має активованої плати або має кілька активованих плат
  без UID-підказки, інструмент зупиняється до підключення CubeProgrammer і до
  старту RDP1 erase.
- **Activate відмовляється стирати захищені вже активовані плати**: Activate
  тепер перевіряє ліцензію до доступу до hardware. Якщо UID заблокований RDP1,
  а ліцензія вже має активовані плати, Activate зупиняється до зняття RDP і
  просить використати Update.
