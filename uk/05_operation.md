...
- На u-blox у прошивці v1.6.15+ стан без фікса або без супутників також виводить `ubxpvt ...`, `ubxrf ...`, `ubxsig ...` і `ubxgnss ...`. `ubxpvt` показує прапори фікса NAV-PVT, `ubxrf` — стан антени/RF, стан jamming і CW interference suppression, `ubxsig` — явний стан jamming/spoofing, якщо приймач це підтримує, а `ubxgnss` — увімкнені блоки GNSS-сузір'їв.
