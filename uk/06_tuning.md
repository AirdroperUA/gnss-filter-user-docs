...
|---|---|---:|---:|---:|
| `RJ_BASE_M` | Базові бокові ворота повторного приєднання (м) | 120 | 10 | 10000 |
...
### Ворота повторного приєднання (rejoin) та таймінги

- **RJ_BASE_M**: Базові бокові ворота для повторного приєднання (rejoin). Це стартова допустима відстань між синтетичною позицією та реальним GNSS. Збільшуйте для довгих DR1; зменшуйте, щоб не приймати великі зміщення.
...
- **RJ_EXP_RMPS**: Швидкість розширення воріт у DR1 (м/с). Дозволяє воротам збільшуватися з часом. Високі значення прискорюють повторне приєднання після довгих DR1, але знижують захист.
