...
- If the STM32 parameters appear as raw names only, install [AirDroper Mission Planner Mod](https://gps.airdroper.org/download/mission-planner-mod) before troubleshooting tuning values.
...
2. Install [AirDroper Mission Planner Mod](https://gps.airdroper.org/download/mission-planner-mod) if descriptions, ranges, units, or option labels are missing.
