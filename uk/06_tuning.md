...
| `HEMI_EN` | Жорстка огорожа північної півкулі (0=вимк., 1=увімк.) | 1 | 0 | 1 |
...
- **FCGPS_FWD**: Примусово пересилає GNSS навіть у DR1. Використовуйте тільки для діагностики; це знімає захист.
...
- **HEMI_EN**: Увімкнення жорсткої огорожі північної півкулі. При `1` (за замовчуванням) будь-яка GPS-широта нижче ~0° миттєво активує DR1 і блокує позицію. Ловить атаки спуфінгу, що телепортують апарат у південну півкулю. Встановіть `0` для роботи у південній півкулі.
