...
- **Update для захищеної плати тепер вимагає підтвердження оператора перед
  ...
  активації та UID-short перед зняттям RDP. CLI вимагає ввести очікуваний
  UID-short або повний UID перед стартом erase. Це не може довести фізичний UID
  до mass erase, але зупиняє сліпе оновлення не тієї захищеної плати.
