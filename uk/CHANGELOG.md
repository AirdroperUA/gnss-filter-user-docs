...
- **Update тепер перевіряє активацію ліцензії до роботи з RDP**: desktop app
  ...
  ліцензія невалідна, не має активованої плати або має кілька активованих
  плат, інструмент зупиняється до підключення CubeProgrammer і до старту RDP1
  erase. Update не вгадує, яка саме захищена плата підключена.
