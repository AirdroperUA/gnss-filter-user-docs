...
- **EKF-тригер**: generic втрата горизонтальної валідності використовує
  `EKF_TRIPMS` (H743 DroneCAN default 500 мс; випущений default F401 0), а
  явний `GPS_GLITCHING` спрацьовує негайно після safety inhibition
...
### Де завантажити патч параметрів Mission Planner?

Завантажте [AirDroper Mission Planner Params](https://gps.airdroper.org/download/mission-planner-mod). Він встановлює описи параметрів, діапазони, одиниці, підписи варіантів і готові `.param` пресети для STM32-фільтра. Закрийте Mission Planner перед запуском інсталятора, потім відкрийте Mission Planner знову й оновіть список параметрів.
