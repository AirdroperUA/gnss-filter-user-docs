...
The Windows **AirDroper GNSS Filter** app version `2026.06.23.6` or newer can
...
2. Open **AirDroper GNSS Filter** app version `2026.06.23.6` or newer.
...
**Reset mode = Software reset**, use app `2026.06.23.6` or newer. That build
