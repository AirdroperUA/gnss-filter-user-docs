...
перевірки відновлення SNR на u-blox F9P та підтримки Mosaic X5 у passive NMEA.
...
v1.6.15 залишалася стабільною версією за замовчуванням на сервері. Замінена
`v1.6.22 (dev)`.
...
v1.6.15 залишалася стабільною версією за замовчуванням на сервері; обирайте
...
v1.6.15 залишалася стабільною версією за замовчуванням на сервері; v1.6.16
