...
Під час no-fix або zero-satellite стану прошивка v1.6.15+ опитує read-only
u-blox diagnostics і логує `ubxpvt ...`, `ubxrf ...`, `ubxsig ...` та `ubxgnss ...` у Mission
Planner. Використовуйте ці рядки, щоб відділити приймач, який відповідає, але
ще виконує acquisition, від antenna/RF/jamming проблеми або вимкненої
...
Під час старту фільтр у цьому режимі робить лише тимчасовий запит "best effort" на:
