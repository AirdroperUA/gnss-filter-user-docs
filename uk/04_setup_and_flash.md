...
- Лише для u-blox параметр `UBX_BAUD` керує автоконфігом/ручним baud:
  ...
  - Gateway-модулі з власним MCU та схемою dual/internal receiver (наприклад Quadro GPS, UNA3, UNA4-SFE або подібні dual-F9P продукти) повинні працювати з `UBX_BAUD>0`; автобауд фільтра для цього класу модулів неможливий.
