...
Перевірки:
1. **Живлення**: GNSS має стабільні 5V (або необхідну напругу) і GND.
2. **UART піни**: GNSS TX -> STM32 `A3` (RX), GNSS RX -> STM32 `A2` (TX).
3. **Швидкість**: GNSS налаштований на `460800` UBX. Якщо ви змінювали baud, оновіть прошивку або переналаштуйте приймач.
...
2. **Протокол порту**: GPS UART на FC має бути **UBlox** і `460800`.
...
2. **Протокол**: телеметрійний порт FC налаштований на MAVLink2 `115200`.
