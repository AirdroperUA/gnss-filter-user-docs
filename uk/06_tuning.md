...
| `FENCE_RAD` | Радіус гео-огорожі від першого фіксу (м, 0=вимкнено) | 0 | 0 | 500000 |
...
- **FENCE_RAD**: Радіус гео-огорожі в метрах від позиції першого фіксу. Якщо GPS показує позицію за цим радіусом — спрацьовує DR1. `0` = вимкнено. Центр огорожі встановлюється при першому фіксі після увімкнення.
