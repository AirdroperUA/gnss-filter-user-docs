...
- STM32F401 BlackPill connected for flashing.
...
## 3.1) Optional Phase-B Secure Boot Build



Build secure-boot images:
...
Phase-B flash addresses:



- bootloader binary at `0x08000000`

- phase-B app binary at `0x08008000`

- signed metadata (`tools/updater/sign_phaseb.py`) at `0x08007C00`



## 4) Flight Controller Serial Setup (ArduPilot)
...
- During DR1, raw UBX forwarding to the FC GPS UART is blocked (unless debug override is enabled in code).
