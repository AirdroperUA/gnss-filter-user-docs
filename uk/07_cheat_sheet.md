...
Фільтр обчислює `DR_CONF` (0–100), комбінуючи 8 сигналів виявлення. Видно в Mission Planner та в логах подій. Вищий бал = більше ознак спуфінгу. Приймачі u-blox використовують всі 8 сигналів; passive NMEA-приймачі, такі як UM980 і Mosaic X5, використовують доступну через NMEA підмножину.
