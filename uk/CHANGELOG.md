...
- **Перевірка статусу прошивки лише за ліцензійним ключем**: desktop app
  ...
  плати з підтвердженим завершеним прошиванням, загальну кількість успішних
  записів, останню прошивку на сервері та час прошивання для кожної плати.
- **Завершене прошивання тепер відстежується окремо від активації**:
  ...
  bootloader та RDP lock. Старі активації можуть показуватися як лише
  зареєстровані, доки їх не оновити версією додатка, яка звітує про фінальний
  успіх.
